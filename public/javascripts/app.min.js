...
$(function(){var i=$("#mainSlider");i.length>0&&i.slick({dots:!0,nextArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--next"><span></span></div>',prevArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--prev"><span></span></div>'}),$(".c-accordion__label").on("click",function(i){i.preventDefault();var c=$(this).closest(".c-accordion__item"),a=c.find(".c-accordion__content");c.toggleClass("c-accordion__item--active"),$(c).hasClass("c-accordion__item--active")?$(a).stop(!0,!0).slideDown(300):$(a).stop(!0,!0).slideUp(275)}),$(".c-docs__item--withModal").fancybox({})});