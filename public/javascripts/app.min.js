...
!function(){this.nmcApp={coldPalit:["#6da1cd","#a6cbeb","#d9edfe","#d2dde6","#a6cbeb","#ecf5fd","#99b4cc"],tabPrefix:"nmc_tab",tabCallbacks:{},showTab:function(tab){var target,tabClass="c-tabs__menu-item--active",tabContent="c-tabs__unit--active",current,cb;if(!tab)var tab=$(".c-tabs__menu-item").first().attr("data-tab");if(current=$(".c-tabs__menu-item[data-tab="+tab+"]"),target="#"+nmcApp.tabPrefix+"_"+tab,0===$(target).length)return void console.error("=> Tab error. \ncan't find tabContent with id "+target);window.location.hash=tab,current.addClass(tabClass).siblings().removeClass(tabClass),$(target).addClass(tabContent).siblings().removeClass(tabContent);try{cb=eval(current.attr("data-cb"))}catch(e){cb=null,console.error("OOps.. Error occured while tab callback's function... see status below: \n"+e)}cb&&cb()},initTabs:function(a){var t=$(".c-tabs__menu-item").first(),a=window.location.hash?window.location.hash.slice(1):t.attr("data-tab");this.showTab(a)},slickOpts:{dots:!0,nextArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--next"><span></span></div>',prevArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--prev"><span></span></div>'},drawPieChart:function(a,t,e){var i=$(t).closest(".c-plot__wrapper").find(".c-plot__legend");e.legend.container=$(i),$.plot(t,a,e),$(t).append('<div class="c-plot__tip"></div>');var n=$(t).offset(),c=$(t).find(".c-plot__tip");$(t).bind("plothover",function(a,t,e){e&&($(c).css({display:"block",top:Math.round(t.pageY-n.top),left:Math.round(t.pageX-n.left)}),$(c).html("<span>"+e.series.label+" "+Math.round(e.series.percent)+" % </span>"))}).bind("mouseleave",function(){$(c).hide()})},smallTab:function(a){var t=$(a).attr("data-tab"),e="c-smalltab__unit--active",i="c-smalltab__menu-item--active";$(t).hasClass(e)||($(a).addClass(i).siblings().removeClass(i),$(t).addClass(e).siblings().removeClass(e))}}}(),$(function(){var mainSlider=$("#mainSlider");mainSlider.length>0&&mainSlider.slick(nmcApp.slickOpts),$(".c-accordion__label").on("click",function(a){a.preventDefault();var t=$(this).closest(".c-accordion__item"),e=t.find(".c-accordion__content");t.toggleClass("c-accordion__item--active"),$(t).hasClass("c-accordion__item--active")?$(e).stop(!0,!0).slideDown(300):$(e).stop(!0,!0).slideUp(275)}),$(".c-docs__item--withModal").fancybox(),$(".c-tabs__menu-item").on("click",function(){var tab=$(this).attr("data-tab"),cb=eval($(this).attr("data-cb"));$(this).hasClass("c-tabs__menu-item--active")||nmcApp.showTab(tab)}),$(".j-datepicker").pickmeup({format:"d-m-Y"}),$(".c-smalltab__menu-item").on("click",function(a){a.preventDefault(),nmcApp.smallTab(this)}),$(".c-burger").on("click",function(){$(".c-header").toggleClass("c-header--active"),$("body").toggleClass("body--on-menu-open")})});