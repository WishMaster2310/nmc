...
!function(){this.nmcApp={coldPalit:["#6da1cd","#a6cbeb","#d9edfe","#d2dde6","#a6cbeb","#ecf5fd","#99b4cc"],tabPrefix:"nmc_tab",tabCallbacks:{},showTab:function(tab){var target,tabClass="c-tabs__menu-item--active",tabContent="c-tabs__unit--active",current,cb;if(!tab)var tab=$(".c-tabs__menu-item").first().attr("data-tab");if(current=$(".c-tabs__menu-item[data-tab="+tab+"]"),target="#"+nmcApp.tabPrefix+"_"+tab,0===$(target).length)return void console.error("=> Tab error. \ncan't find tabContent with id "+target);window.location.hash=tab,current.addClass(tabClass).siblings().removeClass(tabClass),$(target).addClass(tabContent).siblings().removeClass(tabContent);try{cb=eval(current.attr("data-cb"))}catch(e){cb=null,console.error("OOps.. Error occured while tab callback's function... see status below: \n"+e)}cb&&cb()},initTabs:function(t){var a=$(".c-tabs__menu-item").first(),t=window.location.hash?window.location.hash.slice(1):a.attr("data-tab");this.showTab(t)},slickOpts:{dots:!0,nextArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--next"><span></span></div>',prevArrow:'<div class="c-mainSlider__arrow c-mainSlider__arrow--prev"><span></span></div>'},drawPieChart:function(t,a,e){var i=$(a).closest(".c-plot__wrapper").find(".c-plot__legend");e.legend.container=$(i),$.plot(a,t,e),$(a).append('<div class="c-plot__tip"></div>');var c=$(a).offset(),n=$(a).find(".c-plot__tip");$(a).bind("plothover",function(t,a,e){e&&($(n).css({display:"block",top:Math.round(a.pageY-c.top),left:Math.round(a.pageX-c.left)}),$(n).html("<span>"+e.series.label+" "+Math.round(e.series.percent)+" % </span>"))}).bind("mouseleave",function(){$(n).hide()})},smallTab:function(t){var a=$(t).attr("data-tab"),e="c-smalltab__unit--active",i="c-smalltab__menu-item--active";$(a).hasClass(e)||($(t).addClass(i).siblings().removeClass(i),$(a).addClass(e).siblings().removeClass(e))}}}(),$(function(){var mainSlider=$("#mainSlider");mainSlider.length>0&&mainSlider.slick(nmcApp.slickOpts),$(".c-accordion__label").on("click",function(t){t.preventDefault();var a=$(this).closest(".c-accordion__item"),e=a.find(".c-accordion__content");a.toggleClass("c-accordion__item--active"),$(a).hasClass("c-accordion__item--active")?$(e).stop(!0,!0).slideDown(300):$(e).stop(!0,!0).slideUp(275)}),$(".c-docs__item--withModal").fancybox(),$(".c-tabs__menu-item").on("click",function(){var tab=$(this).attr("data-tab"),cb=eval($(this).attr("data-cb"));$(this).hasClass("c-tabs__menu-item--active")||nmcApp.showTab(tab)}),$(".j-datepicker").pickmeup({format:"d-m-Y"}),$(".c-smalltab__menu-item").on("click",function(t){t.preventDefault(),nmcApp.smallTab(this)}),$(".c-burger, .c-header__close").on("click",function(){$(".c-header").toggleClass("c-header--active"),$("body").toggleClass("body--on-menu-open")}),$(".c-header__menu-item").on("click",function(t){var a=$(this);return a.attr("href")?!0:void($(t.target).closest(".c-subnav").length>0||a.toggleClass("--is-active"))}),$(".c-subnav__link").on("click",function(){var t=$(this);return t.attr("href")?!0:void t.toggleClass("--is-active")})});